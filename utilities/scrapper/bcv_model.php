...
class Bank extends Model
{
    ...
    {
        return $this->hasMany(Payment::class, 'bank_emitter_id');
    }

    public function branch_banks()
    {
        return $this->hasMany(BranchBank::class, 'bank_id');
    }

    public static function  getBcvExchangeRate() {
