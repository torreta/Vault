...
export default class CustomGiftedAvatar extends React.Component {
    constructor() {
        super(...arguments);
    ...
    renderAvatar() {
        ...
        if (user) {
            if (typeof user.avatar === 'function') {
                ...
                return (<Image uri={user.avatar} style={[styles.avatarStyle, this.props.avatarStyle]}/>);
            }
...
CustomGiftedAvatar.defaultProps = {
    user: {
        name: null,
        avatar: null,
    },
