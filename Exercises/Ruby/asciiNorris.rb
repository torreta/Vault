...
# translate all caracters on input
@binariMessage = ""

@message_array = @message.split("")

@message_array.each do |letter|
# concat its binary as a long ass binary
    @binariMessage = @binariMessage + translateAsciiBinary(letter)

end

# cicle to translate to unary as chuck said
@unaryMessage = ""
@lastLetter = ""
@counter = 0

@binariMessage = @binariMessage.split("")

@binariMessage.each do |letra|
  ...
  if letra != @lastLetter
   ...
   @unaryMessage = @unaryMessage + "0"
  STDERR.puts @unaryMessage
end


puts @unaryMessage.strip
